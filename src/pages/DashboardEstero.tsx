...
function ProjectSheetEstero({ open, onOpenChange, project, sessionUserId, onSaved }: { open: boolean, onOpenChange: (open: boolean) => void, project: Project | null, sessionUserId: string | null, onSaved: () => void }) {
